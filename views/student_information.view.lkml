view: student_information {
  ...
  dimension: student_details {
    ...
    html:
        <div>
            <img style="float:left;margin:0 100px 0 0;" src="https://fosteradoption.com/wp-content/uploads/2018/06/5-Things-You-Should-Know-about-Older-Child-Adoption-667x445.jpg" height=300 width=445>
            <h1>{{ full_name }}</h1><hr>
            <h4>{{ address1 }}</h4>
            <h4>{{ address2 }}</h4>
            <h4>{{ phone }}</h4><hr>
